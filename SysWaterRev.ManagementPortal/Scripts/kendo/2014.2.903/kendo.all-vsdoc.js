...
kendo.Router.prototype = {
    ...
    replace: function(route, silent) {
        /// <summary>
        ///     Navigates to the given route, replacing the current view in the history stack (like window.history.replaceState or
...
$.fn.kendoRouter = function(options) {
    ...
    ///     &#10;
    ///     &#10;root — String (default: "/")
    ///     &#10;Applicable if pushState is used and the application is deployed to a path different than /. If the application
    ///     start page is hosted on http://foo.com/myapp/, the root option should be set to /myapp/.
    ///     &#10;
    ///     &#10;hashBang — Boolean (default: false)
    ///     &#10;Introduced in the 2014 Q1 Service Pack 1 release. If set to true, the hash based navigation will parse and
    ///     prefix the fragment value with !,
...
$.fn.kendoView = function(options) {
    ...
    ///     &#10;If set to true, the view template will be treated as kendo template and evaluated against the provided model
    ///     instance.
    ///     &#10;
...
kendo.data.GanttDataSource.prototype = {
    taskAllChildren: function(task) {
        ...
        /// </summary>
        /// <param name="task" type="kendo.data.GanttTask">
        ///     The parent task. If this parameter is not specified, all gantt tasks
        ///     will be returned.
        /// </param>
    ...
    taskChildren: function(task) {
        ...
        /// </summary>
        /// <param name="task" type="kendo.data.GanttTask">
        ///     The parent task. If this parameter is not specified, all root level
    ...
    taskSiblings: function(task) {
        ...
        /// <param name="task" type="kendo.data.GanttTask">The reference task.</param>
        /// <returns type="Array">
        ///     the list of all tasks with the same parent as the parameter task. If the parameter task is a root
        ///     level task, all root level tasks are returned.
        /// </returns>
    },

    taskTree: function(task) {
        /// <summary>
        ///     Returns a list of all child gantt tasks, ordered by their hierarchical index (Depth-First). a parent is collapsed,
        ///     it's children are not returned.
        /// </summary>
        /// <param name="task" type="kendo.data.GanttTask">
        ///     The reference task. If this parameter is specified, the result will be
        ///     all child tasks of this task, ordered by their hierarchical index.
        /// </param>
...
$.fn.kendoGanttDependency = function(options) {
    ...
    ///     &#10;The type of the dependency. The type is a value between 0 and 3, representing the four different dependency
    ///     types: 0 - Finish-Finish, 1 - Finish-Start, 2 - Start-Finish, 3 - Start-Start.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
    ///     The widget configuration options
...
$.fn.kendoGanttTask = function(options) {
    ...
    ///     &#10;The percentage of completion of the task. A value between 0 and 1, representing how much of a task is
    ///     completed.
    ///     &#10;
    ///     &#10;start — Date
...
$.fn.kendoPivotDataSource = function(options) {
    ...
    ///     &#10;
    ///     &#10;columns — Array
    ///     &#10;The configuration of columns axis members. An array of JavaScript objects or strings. A JavaScript objects are
    ///     interpreted as column descriptors. Strings are interpreted as the hierarchal name of the member.
    ///     &#10;
    ///     &#10;measures — Array
    ///     &#10;The configuration of measures. An string array which values are interpreted as the name of the measures to be
    ///     loaded.
    ///     &#10;
    ///     &#10;rows — Array
    ///     &#10;The configuration of rows axis members. An array of JavaScript objects or strings. A JavaScript objects are
    ///     interpreted as rows descriptors. Strings are interpreted as the hierarchal name of the member.
    ///     &#10;
    ///     &#10;transport — Object
...
kendo.dataviz.diagram.Connection.prototype = {
    source: function(source) {
        /// <summary>
        ///     Gets or sets the current source of the connection.This object can be a Point for a floating endpoint (i.e. not
        ///     attached to a shape), a Shape or a Connector of a Shape. You can use the Shape.getConnector() method to fetch a
        ///     Connector on the basis of its name. If a Shape is specified the Connection will attach to the "Auto" connector.
        /// </summary>
        /// <param name="source" type="Object">
        ///     If no source is specified the method will return the current object to which the
        ///     Connection's endpoint is attached.
        /// </param>
    ...
    target: function(target) {
        /// <summary>
        ///     Gets or set the target of the Connection.This object can be a Point for a floating endpoint (i.e. not attached to a
        ///     shape), a Shape or a Connector of a Shape. You can use the Shape.getConnector() method to fetch a Connector on the
        ///     basis of its name. If a Shape is specified the Connection will attach to the "Auto" connector.
        /// </summary>
    ...
    targetPoint: function() {
        /// <summary>
        ///     Similar to the sourcePoint, this gets the coordinates of the target of the Connection independently of its endpoint
        ///     attachement.
        /// </summary>
    ...
    type: function(value) {
        /// <summary>
        ///     Gets or sets the (sub-) type of the Connection which defines the way it routes.The routing of a connection is the
        ///     way that intermediate points of a Connection defines a route. A route is usually defined on the basis of
        ///     constraints or behaviors. Currently the framework defines a default polyline route (which simply connects the given
        ///     intermediate points) and a simple rectangular (aka cascading) route. The cascading type is useful when using tree
        ///     layout and hierarchies; the routed Connection will in this case enhance the representation of the hierarchy and
        ///     thus reproduce a classic organization diagram.
        /// </summary>
...
$.fn.kendoConnection = function(options) {
    ...
    ///     &#10;The start cap (arrow, head or decoration) of the connection:Note that you can also use the "ArrowStart" for
    ///     the endCap but its direction will be inversed.
    ///     &#10;
    ///     &#10;points — Array
...
kendo.dataviz.diagram.Shape.prototype = {
    position: function(point) {
        ...
        /// </summary>
        /// <param name="point" type="kendo.dataviz.diagram.Point">
        ///     Either the location to set or if no parameter given returns the
        ///     current location.
        /// </param>
    },
    ...
    connections: function(type) {
        /// <summary>
        ///     Returns the connections attached to the shape. You can optionally specify to return only the incoming or outgoing
        ///     connections.
        /// </summary>
        /// <param name="type" type="String">
        ///     If not parameter specified all connections are returned, if "in" then only the
        ///     incoming (i.e. towards the shape) are returned, if "out" the only the outgoing (i.e. away from the shape) are
        ///     returned.
        /// </param>
    },
    ...
    getPosition: function(side) {
        /// <summary>
        ///     Returns the middle positions of the sides of the bounds or the center of the shape's bounds. This method is useful
        ///     when defining custom connectors where a position function relative to the shape's coordinate system is required.
        /// </summary>
        /// <param name="side" type="String">
        ///     One of the four sides of a bound; "left", "right", "top", "bottom". If none specified
        ///     the center of the shape's bounds will be returned.
        /// </param>
    },
...
$.fn.kendoShape = function(options) {
    ...
    ///     (http://www.w3.org/TR/SVG/paths.html#PathData "SVG Path data.").
    ///     &#10;
    ///     &#10;stroke — Object
    ///     &#10;Defines the stroke configuration.
    ///     &#10;
    ...
    ///     &#10;Defines the minimum width the shape should have, i.e. it cannot be resized to a value smaller than the given
    ///     one.
    ///     &#10;
    ///     &#10;minHeight — Number (default: 20)
    ///     &#10;Defines the minimum height the shape should have, i.e. it cannot be resized to a value smaller than the given
    ///     one.
    ///     &#10;
...
kendo.dataviz.drawing.MultiPath.prototype = {
    ...
    curveTo: function(controlOut, controlIn) {
        /// <summary>
        ///     Draws a cubic Bézier curve (with two control points).A quadratic Bézier curve (with one control point) can be
        ///     plotted by making the control point equal.
        /// </summary>
...
kendo.dataviz.drawing.OptionsStore.prototype = {
    get: function(field) {
        ...
        ///     The field name to retrieve. Must be a fully qualified name (e.g. "foo.bar") for
        ///     nested options.
        /// </param>
    ...
    set: function(field, value) {
        ...
        /// </summary>
        /// <param name="field" type="String">
        ///     The name of the option to set. Must be a fully qualified name (e.g. "foo.bar") for
        ///     nested options.
        /// </param>
        /// <param name="value" type="Object">
        ///     The new option value.If the new value is exactly the same as the new value the
        ///     operation will not trigger options change on the observer (if any).
        /// </param>
    },
...
kendo.dataviz.drawing.Segment.prototype = {
    ...
    controlIn: function(value) {
        /// <summary>
        ///     Gets or sets the first curve control point of this segment.The setter returns the current Segment to allow
        ///     chaining.
        /// </summary>
    ...
    controlOut: function(value) {
        /// <summary>
        ///     Gets or sets the second curve control point of this segment.The setter returns the current Segment to allow
        ///     chaining.
        /// </summary>
        /// <param name="value" type="kendo.dataviz.geometry.Point">The new control point.</param>
        /// <returns type="kendo.dataviz.geometry.Point">The current control point.</returns>
...
kendo.dataviz.geometry.Transformation.prototype = {
    ...
    rotate: function(angle, x, y) {
        ...
        /// </summary>
        /// <param name="angle" type="Number">
        ///     The angle of rotation in decimal degrees. Measured in clockwise direction with 0
        ///     pointing "up". Negative values or values greater than 360 will be normalized.
        /// </param>
...
kendo.dataviz.ui.Barcode.prototype = {
    ...
    resize: function(force) {
        ...
        ///     Defines whether the widget should proceed with resizing even if the element
...
$.fn.kendoTreeMap = function(options) {
    ...
    ///     &#10;The data source of the treeMap which is used to display the tiles and titles. Can be a JavaScript object which
    ///     represents a valid data source configuration, a JavaScript array or an existing kendo.data.HierarchicalDataSource
    ///     &#10;instance.If the HierarchicalDataSource option is set to a JavaScript object or array the widget will
    ///     initialize a new kendo.data.HierarchicalDataSource instance using that value as data source configuration.If the
    ///     HierarchicalDataSource option is an existing kendo.data.HierarchicalDataSource instance the widget will use that
    ///     instance and will not initialize a new one.
    ///     &#10;
    ///     &#10;autoBind — Boolean (default: true)
    ///     &#10;If set to false the widget will not bind to the data source during initialization. In this case data binding
    ///     will occur when the change event of the
    ...
    ///     &#10;
    ///     &#10;colors — Array
    ///     &#10;The default colors for the treemap tiles. When all colors are used, new colors are pulled from the start
    ///     again.
    ///     &#10;
    /// </summary>
    /// <param name="options" type="Object">
...
$.fn.kendoMobileApplication = function(options) {
    ...
    ///     &#10;
    ///     &#10;hashBang — Boolean (default: false)
    ///     &#10;Introduced in the 2014 Q1 Service Pack 1 release. If set to true, the navigation will parse and prefix the url
    ///     fragment value with !,
    ...
    ///     &#10;By default, the mobile application uses flexbox for the mobile views layout. The content element is made
    ///     scrollable, either by initializing a mobile scroller or with the browser supported overflow: auto and
    ///     -webkit-overflow-scrolling: touch CSS declarations.
    ///     &#10;When the useNativeScrolling configuration option is set to true, the view header and footer are positioned
    ///     using position: fixed CSS declaration. The view content vertical padding is adjusted to match the header and footer
    ///     height; The default browser scroller is utilized for the content scrolling.For more information regarding native
    ///     scrolling check this article.
    ///     &#10;
...
$.fn.kendoMobileDrawer = function(options) {
    ...
    ///     &#10;
    ///     &#10;container — jQuery
    ///     &#10;Specifies the content element to shift when the drawer appears. Required if the drawer is used outside of a
    ///     mobile application.
    ///     &#10;
    ...
    ///     &#10;A list of the view ids on which the drawer will appear when the view is swiped. If omitted, the swipe gesture
...
kendo.mobile.ui.ScrollView.prototype = {
    ...
    value: function(dataItem) {
        /// <summary>
        ///     Works in data-bound mode only. If a parameter is passed, the widget scrolls to the given dataItem. If not, the
        ///     method return currently displayed dataItem.
        /// </summary>
...
$.fn.kendoMobileView = function(options) {
    ...
    ///     &#10;Configuration options to be passed to the scroller instance instantiated by the view. For more details, check
    ///     the scroller configuration options.
    ///     &#10;
...
kendo.ui.ComboBox.prototype = {
    ...
    select: function(li) {
        /// <summary>
        ///     Gets or sets the selected item. Slects the item provided as an argument and updates the value and text of the
        ///     widget.
        /// </summary>
...
$.fn.kendoComboBox = function(options) {
    ...
    ///     &#10;The filtering method used to determine the suggestions for the current value. Filtration is turned off by
    ///     default.
...
kendo.ui.ContextMenu.prototype = {
    append: function(item, referenceItem) {
        /// <summary>
        ///     Appends an item to a ContextMenu in the specified referenceItem's sub menu (or the root context menu if not
        ///     specified).
        /// </summary>
        /// <param name="item" type="Object">
        ...
        ///     passed.
        /// </param>
        /// <param name="referenceItem" type="Object">
        ///     A reference item to append the new item in. Root context menu if not
        ///     specified.
        /// </param>
    ...
    close: function(element) {
        ...
        ///     If called without arguments, will close the ContextMenu. If passed an item, it will
        ///     be closed (if opened).
        /// </param>
        /// <returns type="kendo.ui.ContextMenu">Returns the ContextMenu object to support chaining.</returns>
    },
    ...
    destroy: function() {
        /// <summary>
        ///     Prepares the ContextMenu for safe removal from DOM. Detaches all event handlers and removes jQuery.data attributes
        ///     to avoid memory leaks. Calls destroy method of any child Kendo widgets.
        /// </summary>
    },
    ...
    open: function(x, y) {
        /// <summary>
        ///     Shows the ContextMenu at the specified coordinates in pixels or aligned to the specified anchor. If passed an item,
        ///     it will be opened. This method can be prevented to stop the ContextMenu from opening.
        /// </summary>
        /// <param name="x" type="Object">
        ///     X coordinate in pixels or the anchor element to which to align. If passed an item -
        ///     jQuery object or element - it will be opened.
        /// </param>
        /// <param name="y" type="Number">
        ///     Y coordinate in pixels. If not specified, ContextMenu will assume the first parameter is
        ///     an anchor element.
        /// </param>
        /// <returns type="kendo.ui.ContextMenu">Returns the ContextMenu object to support chaining.</returns>
    },
...
$.fn.kendoContextMenu = function(options) {
    ...
    ///     animations in the widget.Available animations for the ContextMenu are listed below.  Each animation has a reverse
    ...
    ///     &#10;
    ///     &#10;filter — String
    ///     &#10;Specifies ContextMenu filter selector - the ContextMenu will only be shown on items that satisfy the provided
    ///     selector.
    ///     &#10;
    ///     &#10;hoverDelay — Number (default: 100)
    ///     &#10;Specifies the delay in ms before the sub menus are opened/closed - used to avoid accidental closure on
    ///     leaving.
    ///     &#10;
    ...
    ///     &#10;Specifies how ContextMenu should adjust to screen boundaries. By default the strategy is "fit" for a sub menu
    ///     with a horizontal parent or the root menu,
    ...
    ///     &#10;
    ///     &#10;showOn — String
    ///     &#10;Specifies the event or events on which ContextMenu should open. By default ContextMenu will show on
    ///     contextmenu event on desktop and hold event on touch devices.
...
$.fn.kendoDropDownList = function(options) {
    ...
    ///     &#10;
    ///     &#10;minLength — Number (default: 1)
    ///     &#10;The minimum number of characters the user must type before a filter is performed. Set to higher value than 1
    ///     if the search could match a lot of items.
    ///     &#10;
...
kendo.ui.Editor.prototype = {
    ...
    exec: function(name, params) {
        ...
        ///     The name of the command to be executed. The available names match the list of tools,
        ///     plus "undo" and "redo".
        /// </param>
...
$.fn.kendoEditor = function(options) {
    ...
    ///     &#10;This is done automatically for all cases except when the policy is relaxed by document.domain =
    ///     document.domain.
    ...
    ///     &#10;
    ///     &#10;stylesheets — Array
    ///     &#10;Allows custom stylesheets to be included within the editing area. This setting is applicable only when the
    ///     Editor is initialized from a textarea
...
kendo.ui.Gantt.prototype = {
    ...
    removeDependency: function(dependency) {
        ...
        /// </summary>
        /// <param name="dependency" type="Object">
    ...
    removeTask: function(task) {
        ...
        ///     The task which should be removed. Also accepts a string which is the uid of the task
    ...
    setDependenciesDataSource: function(dataSource) {
        ...
        /// </summary>
        /// <param name="dataSource" type="kendo.data.GanttDependencyDataSource">
        ///     The dependencies data source to which the widget
        ///     should be bound.
        /// </param>
    },
...
$.fn.kendoGantt = function(options) {
    ...
    ///     &#10;
    ///     &#10;columns — Array
    ///     &#10;The configuration of the gantt columns. An array of JavaScript objects or strings. A JavaScript objects are
    ...
    ///     &#10;The data source of the widget which contains the tasks. Can be a JavaScript object which represents a valid
    ///     data source configuration, a JavaScript array or an existing kendo.data.GanttDataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.GanttDataSource instance using that value as data source configuration.If the dataSource option is an
    ///     existing kendo.data.GanttDataSource instance the widget will use that instance and will not initialize a new one.
    ///     &#10;
    ///     &#10;dependencies — Object|Array|kendo.data.GanttDependencyDataSource
    ///     &#10;The data source of the widget which contains the dependencies. Can be a JavaScript object which represents a
    ///     valid data source configuration, a JavaScript array or an existing kendo.data.GanttDependencyDataSource
    ///     &#10;instance.If the dependencies option is set to a JavaScript object or array the widget will initialize a new
    ///     kendo.data.GanttDependencyDataSource instance using that value as data source configuration.If the dependencies
    ///     option is an existing kendo.data.GanttDependencyDataSource instance the widget will use that instance and will not
    ...
    ///     &#10;If set to true the user could navigate the widget using the keyboard. By default keyboard navigation is
    ///     disabled.
    ///     &#10;
    ///     &#10;workDayStart — Date
    ...
    ///     &#10;If set to true the gantt will snap tasks to the nearest slot during dragging (resizing or moving). Set it to
    ///     false to allow free moving and resizing of tasks.
    ///     &#10;
    ...
    ///     &#10;
    ///     &#10;selectable — Boolean (default: true)
    ///     &#10;If set to false the user won't be able to select tasks in the gantt. By default selection is enabled and
    ...
    ///     &#10;If set to false, the day view will show all hours of the day. By default the view displays only business
    ///     hours.
    ///     &#10;
    ///     &#10;views — Array
    ///     &#10;The views displayed by the gantt and their configuration. The array items can be either objects specifying the
    ///     view configuration or strings representing the view types (assuming default configuration).
...
kendo.ui.Grid.prototype = {
    ...
    dataItem: function(row) {
        /// <summary>
        ///     Returns the data item to which the specified table row is bound.Note to developers using the Grid's MVC wrapper:
        ///     the Grid must be Ajax-bound, otherwise the widget's dataSource instance does not contain the serialized data.
        /// </summary>
        /// <param name="row" type="Object">
        ///     A string, DOM element or jQuery object which represents the table row. A string is
        ///     treated as a jQuery selector.
...
$.fn.kendoGrid = function(options) {
    ...
    ///     &#10;If a String value is assigned to the toolbar configuration option, it will be treated as a single string
    ///     template for the whole Grid toolbar,
    ///     &#10;and the string value will be passed as an argument to a kendo.template() function.If a Function value is
    ///     assigned (it may be a kendo.template() function call or a generic function reference), then the return value of the
    ///     function will be used to render the Grid toolbar contents.If an Array value is assigned, it will be treated as the
    ///     list of commands displayed in the grid toolbar. Commands can be custom or built-in ("cancel", "create", "save").The
    ///     "cancel" built-in command reverts any data changes done by the end user.The "create" command adds an empty data
    ///     item to the grid.The "save" command persists any data changes done by the end user.
    ///     &#10;
    ///     &#10;toolbar — Array
    ///     &#10;If a String value is assigned to the toolbar configuration option, it will be treated as a single string
    ///     template for the whole Grid toolbar,
...
$.fn.kendoMaskedTextBox = function(options) {
    ...
    ///     &#10;Specifies whether the widget will replace the prompt characters with spaces on blur. Prompt chars will be
    ///     shown again on focus.
    ///     &#10;
    ///     &#10;culture — String (default: "en-US")
    ///     &#10;Specifies the culture info used by the widget.
    ///     &#10;
...
$.fn.kendoPivotConfigurator = function(options) {
    ...
    ///     &#10;The data source of the widget which is used to display values. Can be a JavaScript object which represents a
    ///     valid data source configuration or an existing kendo.data.PivotDataSource
    ///     &#10;instance.If the dataSource option is set to a JavaScript object the widget will initialize a new
    ///     kendo.data.PivotDataSource instance using that value as data source configuration.If the dataSource option is an
    ///     existing kendo.data.PivotDataSource instance the widget will use that instance and will not initialize a new one.
    ///     &#10;
    ///     &#10;filterable — Boolean (default: false)
...
kendo.ui.PivotGrid.prototype = {
    ...
    cellInfoByElement: function(cell) {
        ...
        /// </summary>
        /// <param name="cell" type="Object">
        ///     A string, DOM element or jQuery object which represents the data table cell. A string
        ///     is treated as a jQuery selector.
        /// </param>
        /// <returns type="Object">the data cell information.The fields of the result object:</returns>
    },
...
$.fn.kendoPivotGrid = function(options) {
    ...
    ///     &#10;The template which renders the content of the column header cell. By default it renders the caption of the
    ///     tuple member.The fields which can be used in the template are:For information about the tuple structure check this
    ///     link.
    ///     &#10;
    ///     &#10;dataCellTemplate — String|Function
    ///     &#10;The template which renders the content of the data cell. By default renders the formatted value (fmtValue) of
    ///     the data item.The fields which can be used in the template are:For information about the tuple structure check this
    ///     link.
    ///     &#10;About the data item structure review this help topic.
    ///     &#10;
    ///     &#10;rowHeaderTemplate — String|Function
    ///     &#10;The template which renders the content of the row header cell. By default it renders the caption of the tuple
    ///     member.The fields which can be used in the template are:For information about the tuple structure check this link.
    ///     &#10;
    ///     &#10;messages — Object
    ///     &#10;The text messages displayed in the fields sections.
    ///     &#10;
...
$.fn.kendoScheduler = function(options) {
    ...
    ///     &#10;The template used to render the date header cells.By default the scheduler renders the date using a custom
    ///     date format - "ddd M/dd".
    ///     &#10;The "ddd" specifier, a.k.a abbreviated name of the week day, will be localized using the current Kendo UI
    ///     culture.
    ///     &#10;If the developer wants to control the day and month order then one needs to define a custom template.The
    ///     fields which can be used in the template are:
    ///     &#10;
    ///     &#10;editable — Boolean (default: true)
...
$.fn.kendoSortable = function(options) {
    ...
    ///     &#10;Selector that determines which elements inside the sorted item's container will be ignored. Useful if the
    ///     sortable item contains input elements.
    ///     &#10;
...
kendo.ui.ToolBar.prototype = {
    ...
    enable: function(command, enable) {
        /// <summary>
        ///     Enables or disables the specified command. If the second parameter is omitted it will be treated as true and the
        ///     command will be enabled.
        /// </summary>
        /// <param name="command" type="Object">
        ///     A string, DOM element or jQuery object which represents the command to be enabled
        ///     or disabled. A string is treated as jQuery selector.
        /// </param>
        /// <param name="enable" type="Boolean">
        ///     A boolean flag that determines whether the command should be enabled (true) or
        ///     disabled (false). If omitted the command will be enabled.
        /// </param>
    },
    ...
    remove: function(command) {
        /// <summary>
        ///     Removes a command from the ToolBar widget. The command is removed from the ToolBar container and overflow popup (if
        ///     resizable is enabled).
        /// </summary>
        /// <param name="command" type="Object">
        ///     A string, DOM element or jQuery object which represents the command to be removed.
        ///     A string is treated as jQuery selector.
        /// </param>
    },
...
$.fn.kendoToolBar = function(options) {
    ...
    ///     &#10;If resizable is set to true the widget will detect changes in the viewport width and hides the overflowing
    ///     controls in the command overflow popup.
    ///     &#10;
    ///     &#10;items — Array
...
kendo.ui.Widget.prototype = {
    ...
    setOptions: function(newOptions) {
        /// <summary>
        ///     Allows changing the widget configuration after initialization. Depending on the widget, some properties may not be
        ///     changed, e.g. ones that influence the widget's HTML output (such as Grid scrollability or columns).
        /// </summary>
...
$.fn.kendoWindow = function(options) {
    ...
    ///     &#10;Determines whether the Window will be focused automatically when opened. The property also influences the
    ///     focus behavior when the Window is clicked when already opened.
    ///     &#10;
    ///     &#10;content — String
