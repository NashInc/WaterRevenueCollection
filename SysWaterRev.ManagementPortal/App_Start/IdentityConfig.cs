...
namespace SysWaterRev.ManagementPortal
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var emailMessage = new MailMessage(Settings.Default.EmailAccount, message.Destination, message.Subject,
                message.Body);
            var smtpClient = new SmtpClient(Settings.Default.SendGridHost, Settings.Default.SendGridPort)
            {
                EnableSsl = true,
                Credentials =
                    new NetworkCredential(Settings.Default.SendGridUserName, Settings.Default.SendGridPassword)
            };
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var gateway = new AfricasTalkingGateway(Settings.Default.AfricaTalkingUserName, Settings.Default.AfricaTalkingAPIKey);
