...
namespace SysWaterRev.ManagementPortal.Controllers
{
    ...
    public class EmployeesController : AbstractController
    {
        ...
        {
            var employeeWithMeters = db.Readings.Where(x => x.EmployeeId == EmployeeId)
            ...
            return Json(employeeWithMeters);
        }
        ...
        public async Task<ActionResult> Create(EmployeeViewModel employee, params string[] selectedRoles)
        {
            try
            {
                ...
                var callBackUrl=await SendEmailConfirmationTokenAsync(appUser.Id, "Confirm your Account");
        ...
        public async Task<ActionResult> Edit(EmployeeViewModel employee)
        {
            ...
            if (applicationUser != null)
            {
                ...
                var callBackUrl = await SendEmailConfirmationTokenAsync(applicationUser.Id, "Confirm your Account");
                return RedirectToAction("Index");
            }
